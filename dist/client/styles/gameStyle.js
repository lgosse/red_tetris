...
var animations = {
  pulse: (0, _styledComponents.keyframes)(_templateObject),
  bombExplodeV: (0, _styledComponents.keyframes)(_templateObject2),
  bombExplodeH: (0, _styledComponents.keyframes)(_templateObject3),
  tnt: (0, _styledComponents.keyframes)(_templateObject4),
  fire: (0, _styledComponents.keyframes)(_templateObject5),
  bomb: (0, _styledComponents.keyframes)(_templateObject6),
  reflect: (0, _styledComponents.keyframes)(_templateObject7)
};
...
var gameStyle = {
  ...
  tnt: {
    ...
    base: {
      ...
      background: "linear-gradient(to right, black, red, red, red, black, red, red, red, black, red, red, red, black)"
    },
    bip: {
      width: "1vh",
      height: "1vh",
  ...
  bomb: {
    explode: function explode(x, y, axe) {
      return {
        zIndex: "3",
        ...
        height: "4vh",
        background: axe === 0 ? "linear-gradient(red, yellow, red)" : axe === 1 ? "linear-gradient(to right, red, yellow, red)" : "radial-gradient(circle, red, yellow, red)",
        animation: axe === 0 ? animations.bombExplodeH + " 0.2s infinite" : axe === 1 ? animations.bombExplodeV + " 0.2s infinite" : "none",
        animationDirection: "alternate"
      };
    },
    all: {
  ...
  squareIn: function squareIn(color) {
    return {
