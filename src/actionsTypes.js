...
export const GAME_PIECES_HOLD = 'GAME_PIECES_HOLD';
export const GAME_PIECES_RESET_HOLD = 'GAME_PIECES_RESET_HOLD';
...
export const GAME_BOARD_DELETE_LINES_SOUND = 'GAME_BOARD_DELETE_LINES_SOUND';
